...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Os membros docentes do Colegiado terão mandato de três anos.
	\end{enumerate}
	...
	\begin{enumerate}
		\item O Coordenador e o Coordenador Adjunto são eleitos entre os membros do corpo docente do Programa através de votação pelo Colegiado. O Coordenador e Coordenador Adjunto serão os membros com o primeiro e segundo maior número de votos, respectivamente.
		\item Os mandatos serão de dois anos e será permitida apenas uma recondução sucessiva aos cargos.
	\end{enumerate}

	\item Os Representantes Discentes são eleitos através de votação pelos alunos regulares dos respectivos cursos que representarão, para mandatos de 1 (um) ano.
	\begin{enumerate}
		...
		\item Na ausência, por qualquer motivo, de representação discente, cabe ao Colegiado realizar o processo de votação para escolha do Representante Discente e seu suplente.
	\end{enumerate}	
...
\begin{enumerate}
	...
	\begin{enumerate}[label=\Roman*]
		...
		\item Convocar e presidir as reuniões do Colegiado do Programa;
		...
		\item Decidir ``ad referendum'' sobre matéria de urgência do Colegiado;
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item O docente que ao final de um ano não atingir a Meta Individual Mínima definida pelo Colegiado, não poderá acolher novos Orientandos;

		\item O docente que em dois anos consecutivos não atingir a Meta Individual Mínima definida pelo Colegiado, não terá disciplina a ele atribuída.
	\end{enumerate}
\end{enumerate}
...
\begin{enumerate}
	...
	\begin{enumerate}
		\item Durante três avaliações consecutivas, não atingir a Meta Individual Mínima definida pelo Colegiado, exceto nos casos onde:
		\begin{enumerate}
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item A alteração de Orientação pode ser solicitada a qualquer tempo que anteceda seis meses a data da Defesa da Dissertação ou doze meses a data de Defesa de Tese e será objeto de apreciação e parecer do Colegiado.
	\end{enumerate}
	...
	\begin{enumerate}[label=\Roman*]
		\item 	Elaborar, juntamente com o aluno, o Plano de Estudos a ser desenvolvido e encaminhá-lo ao Colegiado, dentro dos prazos regulamentares;
		...
		\item	Sugerir ao Colegiado os nomes dos integrantes de Bancas Examinadoras e a data para a realização da defesa de seus orientandos;
...
\begin{enumerate}
	...
	\begin{enumerate}
		\item As Disciplinas Obrigatórias serão definidas pelo Colegiado em resolução própria;
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item O prazo máximo estabelecido neste Artigo poderá ser prorrogado excepcionalmente por até seis meses, por recomendação do Orientador, com aprovação do Colegiado, caso o Mestrando tenha cumprido todos os requisitos, exceto a apresentação da Dissertação.
	\end{enumerate}
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item O prazo máximo estabelecido neste Artigo poderá ser prorrogado excepcionalmente por até seis meses, por recomendação do Orientador, com aprovação do Colegiado, caso o Doutorando tenha cumprido todos os requisitos, exceto a apresentação da Tese.
	\end{enumerate}
...
\begin{enumerate}
	...
	\item  A Proposta de Dissertação ou Tese é atividade obrigatória e visa explicitar o problema a ser abordado pelo aluno em seu trabalho, estabelecendo os objetivos, argumentando sobre a relevância do problema à área, apresentando como a Proposta se distingue de trabalhos anteriores e relacionados, propondo uma metodologia de pesquisa a ser utilizada e apresentando um cronograma de trabalho.
	\begin{enumerate}
		\item A defesa da Dissertação ou Tese não poderá ocorrer antes de transcorridos ao menos seis meses da aprovação da Proposta.
		\item A Proposta de Dissertação será avaliada por no mínimo um relator, enquanto a Proposta de Tese será avaliada por no mínimo dois relatores.
		\item Os relatores serão indicados pela Comissão de Acompanhamento Discente.
		\item Caso a Proposta seja reprovada, o aluno deve apresentar nova Proposta nos prazos especificados pelos relatores.
	...
	\begin{enumerate}
		...
		\item A defesa da Dissertação ou Tese não poderá ocorrer antes de transcorridos ao menos quatro meses da aprovação no Seminário de Andamento.
	...
	\item  O Exame de Qualificação é atividade obrigatória para alunos de Doutorado e visa avaliar conhecimentos em áreas necessárias à Tese, em prazo e formato definidos pelo Colegiado através de Resolução própria.
	\begin{enumerate}
	...
	\item A Docência Orientada visa...
	\begin{enumerate}
		\item As atividades serão realizadas em disciplina de graduação, sob orientação de um professor responsável.
		\item As atividades devem se distribuir ao longo de 1 (um) semestre letivo, não podendo ultrapassar 2 (duas) horas semanais.
	...
	\begin{enumerate}
		...
		\item As atividades consideradas complementares, os créditos associados e as formas de verificação para cada atividade serão definidos pelo Colegiado em resolução própria.
	\end{enumerate}
...
\begin{enumerate}
	...
	\begin{enumerate}
		\singleitem O Colegiado indicará uma comissão que avaliará o mérito da solicitação. Em caso de aprovação, o estudante terá um prazo de 90 dias para defender a dissertação. %% E... ? Tem que especificar o que acontece depois e se não for aprovado.
	\end{enumerate}

	\item Em casos especiais, a critério do Colegiado, durante a realização do Mestrado em Ciência da Computação será permitida a alteração da inscrição para Doutorado, com o aproveitamento integral dos créditos já obtidos.	
