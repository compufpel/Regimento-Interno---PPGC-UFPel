...
\begin{enumerate}
	...
	\begin{enumerate}
		\singleitem O Colegiado indicará uma comissão que avaliará o mérito da solicitação. Em caso de aprovação da solicitação, o estudante terá um prazo de 90 dias para defender a dissertação. Tendo sua dissertação aprovada, a alteração de nível será concedida.
	\end{enumerate}
