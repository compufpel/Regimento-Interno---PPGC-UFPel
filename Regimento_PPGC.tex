...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Os mandatos serão de dois anos e serão permitidas apenas uma recondução sucessiva aos cargos.
	\end{enumerate}
...
\begin{enumerate}
	...
	\begin{enumerate}[label=\Roman*]
		...
		\item 	Ter sido aprovado seu Seminário de Andamento de Dissertação de Mestrado;
...
\section{Das Atividades Obrigatórias}
\begin{enumerate}

	\item  A Proposta de Dissertação ou Tese visa explicitar o problema a ser abordado pelo aluno em seu trabalho, argumentando sobre a relevância do problema à área, apresentando como a Proposta se distingue de trabalhos anteriores e relacionados, propondo uma metodologia a ser utilizada e apresentando um cronograma de trabalho.
	\begin{enumerate}
	...
	\item O Seminário de Andamento visa o acompanhamento do trabalho do aluno de forma a verificar seu progresso, no contexto de sua Proposta, permitindo a identificação de problemas com antecedência e o conhecimento e discussão do trabalho pela comunidade.
	\begin{enumerate}
	...
	\item  O aluno de Doutorado deverá ser aprovado em um Exame de Qualificação, que avaliará conhecimentos em áreas necessárias à Tese, em prazo e formato definidos pelo Colegiado através de Resolução própria.
	\begin{enumerate}
...
% \section{Das Atividades Complementares}
% \begin{enumerate}
