...
\usepackage{titlesec}
\usepackage[brazilian]{babel} % para hifenizacao e outras coias
...
% 	\end{enumerate}
% 	\begin{enumerate}
% 		\singleitem O Colegiado do PPGC é o seu órgão máximo de deliberação, sendo a Câmara de Pós-Graduação ``Stricto Sensu'' da Pró-reitoria de Pesquisa e Pós-Graduação desta Universidade o órgão imediatamente superior.
% 	\end{enumerate}
