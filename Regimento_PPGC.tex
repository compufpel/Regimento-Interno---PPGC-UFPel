...
\begin{enumerate}
	...
	\begin{enumerate}[label=\Roman*]
		...
		\item Permanentes – aqueles que atuam com preponderância no curso, atuando, de forma regular, na oferta de disciplinas, no desenvolvimento de pesquisas, na orientação de alunos e de outras atividades necessárias para a manutenção satisfatória do Programa. % incluir que tem que ser empregado da ufpel?
	...
	\end{enumerate}
		...
		% Mencionar que a proporção de permanentes não pode ser inferior a x% (70?)
...
\begin{enumerate}
	...
	\begin{enumerate}
		\item Cada membro do Corpo Docente poderá orientar até oito alunos simultaneamente.
