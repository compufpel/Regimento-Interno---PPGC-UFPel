...
\begin{enumerate}
	...
	\item Assessoram nas decisões do Colegiado duas Comissões permanentes, cujos membros são indicados pelo Colegiado, anualmente, entre os membros do corpo docente do Programa:
	\begin{enumerate}[label=\Roman*]
...
\begin{enumerate}
	...
	\begin{enumerate}[label=\Roman*]
		...
		\item Estabelecer metas de qualidade de curto, médio e longo prazo para o Programa, bem como estratégias para atingir estas metas;
		...
		\item Definir a Meta Mínima de Produção e a Meta Global para fins de processos de avaliação dos docentes;
...
\begin{enumerate}
	\begin{enumerate}[label=\Roman*]
		...
		\item Estabelecer valores desejáveis às métricas estabelecidas, considerando as metas de curto, médio e longo prazo definidas pelo Colegiado;
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			\item A Meta Global anual de produção do Programa, definida pelo Colegiado, for atingida; ou,
